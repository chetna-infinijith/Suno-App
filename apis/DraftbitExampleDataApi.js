...
export const exampleDataList10GET = async (
  Constants,
  _args,
  handlers,
  timeout
...
export const useExampleDataList10GET = (
  args = {},
  {
    refetchInterval,
  ...
  return useQuery(
    ...
    () => exampleDataList10GET(Constants, args, handlers, timeout),
    {
      refetchInterval,
      refetchOnWindowFocus,
      refetchOnMount,
